  ...
  if (sent) {
    return (
      <div className="w-full max-w-sm text-center">
        ...
        <p className="text-muted-foreground mt-2 text-sm">We sent a magic link to <strong className="text-foreground">{email}</strong>. Click it to sign in.</p>
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2 text-sm">Sign in to your Luma account</p>
      </div>
